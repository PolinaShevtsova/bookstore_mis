            ...
            <div className={styles.Content}>
              ...
              <thead>
                <tr>
                  ...
                  <th style={{width: '95px',  border: '2px solid #5D3C64'}}>Название книги</th>
                  <th style={{width: '205px',  border: '2px solid #5D3C64'}}>Авторы</th>
                  <th style={{width: '195px',  border: '2px solid #5D3C64'}}>Причина списания</th>
                  <th style={{width: '140px',  border: '2px solid #5D3C64'}}>Количество экземпляров</th>
                  <th>Дата и время</th>
                </tr>
              </thead>
              <tbody>
